    ...
    var thirdMenuOpen;
    function start() {
        //specifies menus are closed at start
        mainMenuOpen = false;
        firstMenuOpen = false;
        ...
        //music
        id.value = "menu-icon";
        geometry.value = "primitive: box; height: 1; width: 1.5";
        material.value = "color: black; opacity: 0.4";
        position.value = "0 -5 3";
        menuicon.setAttributeNode(id);
        menuicon.setAttributeNode(geometry);
        menuicon.setAttributeNode(material);
        menuicon.setAttributeNode(scale);
    ...
    function openMainMenu() {
        ...
        id.value = "menu-icon";
        geometry.value = "primitive: box; height: 1; width: 1.5";
        material.value = "color: black; opacity: 0.7";
        position.value = "0 -5 3";
        menuicon.setAttributeNode(id);
        menuicon.setAttributeNode(geometry);
        menuicon.setAttributeNode(material);
    ...
    function closeMainMenu() {
        ...
        menuicon.setAttributeNode(id);
        menuicon.setAttributeNode(geometry);
        menuicon.setAttributeNode(color);
        menuicon.setAttributeNode(scale);
        menuicon.setAttributeNode(position);
        element.appendChild(menuicon);
        var menuicon = document.getElementById("menu-icon");
